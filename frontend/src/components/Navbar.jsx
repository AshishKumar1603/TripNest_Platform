            ...
            {isDropdownOpen && (
              <>
                ...
                <div className="absolute right-0 mt-3 w-60 bg-white border border-gray-200 rounded-2xl shadow-2xl py-2 z-50 overflow-hidden animate-in fade-in zoom-in duration-150">
                  {!user ? (
                    <div className="flex flex-col">
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-sm text-gray-800 hover:bg-gray-50 flex items-center gap-3 font-bold cursor-pointer"
                      >
                        <UserPlus size={18} className="text-[#FF385C]" /> Sign
                        up
                      </button>
                      <button
                        onClick={() => handleNav("/login")}
                        className="w-full text-left px-4 py-3 text-sm text-gray-800 hover:bg-gray-50 flex items-center gap-3 font-medium cursor-pointer"
                      >
                    ...
                    <div className="flex flex-col">
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-sm text-rose-600 hover:bg-rose-50 flex items-center gap-3 font-bold cursor-pointer"
                      >
                  ...
                  <button
                    onClick={() => handleNav("/listings/new")}
                    className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-3 font-semibold cursor-pointer"
                  >
                    <PlusCircle size={18} className="text-gray-400" /> Add New
                    Home
                  </button>
                  ...
                  <button
                    ...
                    className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-3 font-semibold cursor-pointer"
                  >
                    <MessageSquare size={18} className="text-gray-400" /> Chat
                    with AI
                  </button>
                </div>
              </>
