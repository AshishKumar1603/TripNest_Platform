      ...
      <div className="container mx-auto px-6 md:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="footer-item">
            ...
            <hr className="w-[70%] border-gray-300 mb-4" />
            <div className="flex flex-col">
              <a href="#" className={footerLinkStyle}>TripNest your home</a>
          ...
          {/* Brand Section */}
          <div className="footer-item">
            <h5 className={sectionTitleStyle}>TripNest</h5>
            <hr className="w-[70%] border-gray-300 mb-4" />
            <div className="flex flex-col">
              ...
              <a href="#" className={footerLinkStyle}>TripNest.org emergency</a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-8">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
              ...
              <b className="text-2xl font-bold tracking-tight text-[#FF385C]">TripNest</b>
            </div>
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-gray-600 text-sm font-semibold">
            &copy; 2026 TripNest Private Limited, inc.
          </div>
